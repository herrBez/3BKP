...
\end{equation}
può essere tralasciato senza intaccare l'ammissibilità del problema.\footnote{Nel paper originale viene considerato esclusivamente per questioni numeriche.}.
